CREATE database `SOAPBOX` DEFAULT CHARACTER SET utf8 DEFAULT COLLATE UTF8_UNICODE_CI;
CREATE TABLE
...
ALTER TABLE
    SOAPBOX.PROMO_CODE ADD CONSTRAINT FK_PROMOCODE_USER FOREIGN KEY (USERID) REFERENCES USER (ID);
