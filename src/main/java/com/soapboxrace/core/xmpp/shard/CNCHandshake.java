...
public class CNCHandshake implements IHandshake
{
    ...
    public CNCHandshake()
    {
        ...
        String user = "sbrw.engine.engine";
        String password = PARAMETER_BO.getCncToken();
        ...
        openFireTalk = new CNCOpenFireTalk(socketClient.getSocket());
