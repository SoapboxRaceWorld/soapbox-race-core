...
@NamedQueries({ //
        ...
        @NamedQuery(name = "ProductEntity.findDropsByType", query = "SELECT obj FROM ProductEntity obj WHERE obj.productType = :type AND obj.isDropable = true AND obj.enabled = true"), //
